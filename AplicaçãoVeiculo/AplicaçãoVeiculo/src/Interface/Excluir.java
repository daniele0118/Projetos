...
public class Excluir extends javax.swing.JDialog {
    ...
    public Excluir(java.awt.Frame parent, boolean modal, Informacoes informacoes) {
        super(parent, modal);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        boolean sucesso = informacoes.excluir(placa);
        if(sucesso){
            String message = "Veículo excluido com sucesso";
